...
public class FixedIndicatorView extends LinearLayout implements Indicator {
    ...
    public static final int SLIDE_VERTICLE_PADDING = 0;
        ...
        public void onChange() {
            ...
            for (int i = 0; i < newCount; i++) {
                ...
                if (i < size) {
                    ...
                    view = mAdapter.getView(i, temp, result, mSelectedTabIndex);
                } else {
                    view = mAdapter.getView(i, null, result, mSelectedTabIndex);
                }
                result.addView(view);
    ...
    private void drawSlideBar(Canvas canvas) {
        ...
        switch (this.scrollBar.getGravity()) {
            ...
            case BOTTOM_FLOAT:
            default:
                offsetY = getHeight() - scrollBar.getHeight(getHeight()) - DensityUtil.dip2px(getContext(), SLIDE_VERTICLE_PADDING);
                break;
        }
        ...
        int width = scrollBar.getSlideView().getWidth() - DensityUtil.dip2px(getContext(), PADDING);
